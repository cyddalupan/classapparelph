    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <button type="button" class="btn btn-outline-info" onclick="openProdSlipModal()">
                <i class="fas fa-clipboard-list"></i> Production Slip
            </button>
...
<div class="modal fade" id="prodSlipModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Production Slip — Order #{{ $sale->sales_number }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <!-- Tab bar -->
...
function openProdSlipModal() {
    ...
    if (fbBody) fbBody.dataset.loaded = '';
...
document.addEventListener('click', function(e) {
    ...
    if (tabName === 'addProdSlip') {
        ...
        if (fbBody) {
            ...
            if (!fbBody.dataset.loaded || fbBody.dataset.saleId !== String(psSaleId)) {
...
function loadFreebieSlipTab(saleId) {
    ...
    if (!body) return;
    saleId = saleId || (typeof psSaleId !== 'undefined' ? psSaleId : null);
...
function freebieToggleCheck(requestId, role, el) {
    ...
    .then(function(data) {
        ...
        if (typeof FREEBIE_REFRESH === 'function') FREEBIE_REFRESH();
    })
