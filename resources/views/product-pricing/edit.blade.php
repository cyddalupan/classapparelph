                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="pricingTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="standard" role="tabpanel" aria-labelledby="standard-tab">
                            <form action="{{ route('product-pricing.update', $item->id) }}" method="POST" id="pricingForm">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="supplier_cost" 
                                                       name="supplier_cost_base_price" step="0.01" min="0" required
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="sales_team_price" 
                                                       name="sales_team_final_price" step="0.01" min="0"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="agent_base_price" 
                                                       name="agent_cost_base_price" step="0.01" min="0"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="agent_markup_percentage" 
                                                       name="agent_cost_markup_percentage" step="0.1" min="0" max="100"
...
$(document).ready(function() {
    ...
    // Calculate pricing values before main form submission
    $('#pricingForm').submit(function(e) {
        // Calculate sales team markup
        ...
        if (salesFinal > 0 && supplierBase > 0) {
            const salesMarkupAmount = salesFinal - supplierBase;
            const salesMarkupPercentage = (salesMarkupAmount / supplierBase) * 100;
            
            // Add hidden fields
            $('<input>').attr({
                type: 'hidden',
                name: 'sales_team_markup_amount',
                value: salesMarkupAmount.toFixed(2)
            }).appendTo('form');
            
            $('<input>').attr({
                type: 'hidden',
                name: 'sales_team_markup_percentage',
                value: salesMarkupPercentage.toFixed(2)
            }).appendTo('form');
        }
        
        // Calculate agent pricing
        const agentBase = parseFloat($('#agent_base_price').val()) || 0;
        const agentMarkupPercent = parseFloat($('#agent_markup_percentage').val()) || 0;
        
        if (agentBase > 0 && agentMarkupPercent > 0) {
            const agentMarkupAmount = (agentBase * agentMarkupPercent) / 100;
            const agentFinalPrice = agentBase + agentMarkupAmount;
            
            // Add hidden fields
            $('<input>').attr({
                type: 'hidden',
                name: 'agent_cost_markup_amount',
                value: agentMarkupAmount.toFixed(2)
            }).appendTo('form');
            
            $('<input>').attr({
                type: 'hidden',
                name: 'agent_cost_final_price',
                value: agentFinalPrice.toFixed(2)
            }).appendTo('form');
        }
    });
