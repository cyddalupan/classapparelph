...
Route::get('/inventorylist', function() {
    return view('inventory.create-clean');
        ...
        Route::delete('/sales/prototype/{id}/design-image', [App\Http\Controllers\PrototypeSalesController::class, 'deleteDesignImage'])->name('sales.prototype.delete-design-image');
