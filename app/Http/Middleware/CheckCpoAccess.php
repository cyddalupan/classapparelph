...
/**
 * Blocks CPO users from routes that are NOT in their allowed navigation.
 * Anything grayed out or hidden in the CPO navbar must return 403 here,
 * even if the user knows the direct link.
 */
class CheckCpoAccess
{
    /**
     * Route names a CPO may NOT access (blocklist).
     */
    protected array $blockedRoutes = [
        ...
        // Sales pages NOT in CPO nav (kanban, manager list, full sales dashboard, delays, etc.)
        ...
        // Extra sales entry pages (not in CPO nav)
