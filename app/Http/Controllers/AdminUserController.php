...
class AdminUserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $roleCounts = [
            ...
            'coo' => User::where('role', 'coo')->count(),
            'cpo' => User::where('role', 'cpo')->count(),
            'cmo' => User::where('role', 'cmo')->count(),
            'prod_manager' => User::where('role', 'prod_manager')->count(),
            'qa' => User::where('role', 'qa')->count(),
            'hr_accountant_agent' => User::where('role', 'hr_accountant_agent')->count(),
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'role' => ['required', 'in:admin,sales_agent,sales_representative,staff,procurement,artist,coo,cpo,cmo,prod_manager,ga,qa,accountant,hr_accountant_agent,customer'],
